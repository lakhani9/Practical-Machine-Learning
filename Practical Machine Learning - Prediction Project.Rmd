...
# knitr::opts_chunk$set(echo = FALSE,fig.align='center',fig.height=5,fig.width=8,warning=FALSE)
...
```{r validate clean data,echo=FALSE,results='hide'}
...
```{r rpart model,echo=FALSE,results='hide'}
...
```{r rf model,echo=FALSE,results='hide',warning=FALSE}
set.seed(12345)
...
```{r gbm model,echo=FALSE,results='hide',warning=FALSE}
